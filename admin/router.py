...
async def get_all_cars(limit: Optional[int] = None, offset: Optional[int] = None):
    """
    ...
    """
    try:
        result = await async_orm.get_all_cars_for_admin(limit, offset)
...
async def add_car(car_brand: str, car_model: str, rent_deposit: int, car_class: str,
    ...
    await async_orm.add_car(car_brand, car_model, rent_deposit, car_class,
...
async def update_car(car_id: int, car_brand: Optional[str] = None, car_model: Optional[str] = None,
    ...
    await async_orm.update_car_by_id(car_id, car_brand, car_model, rent_deposit, car_class, drive_unit, car_fuel,
...
async def delete_car(car_id: int):
    ...
    :return:
    """
    await async_orm.delete_car_by_id(car_id)
...
async def get_car_by_id(car_id: int):
    ...
    :return:
    """
    result = await async_orm.get_car_by_id_for_admin(car_id)
